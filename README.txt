...
There's a level editor you can play around with: F2 to toggle it, escape to
show the available things, mouse to do stuff with the things.
...
Each affect of the event will be of the form [*], where star is the data of the
block. In the above example either * = "WT, w0" or * = "-1". The first
component is from the following list
...
(It is easy to see what you can move to using left and right, they are the
...
Thing work slightly differently on the affect side, up and down now move right
and left within the affect block.
